...
public class Fuente extends Thread {
	...
	/**
	 * Es posible que se produzca la llamada de otro proceso antes de que se haya 
	 * actualizado el campo vida y entonces se producen  dos llamadas en el mismo
	 * valor de vida
	 * @return
	 */
	public int beber() {
	...
	public void run() {
		while (seguir) {
			...
			alimento++;
			//si ponemos esta linea le da tiempo a cambiar el valor vida antes de la 
